$(document).ready(function() {
  ...
  .data("owl.carousel").onResize(), $(".owl-carousel.single1").length > 0 && $(".owl-carousel.single1").owlCarousel({
      margin: 30,
      items: 1,
      loop: false,
      stagePadding: 15,
	 autoHeight: true,
      dotsContainer: $(".owl-carousel.single1").parents(".owl-container").find(".slider-dot-container")
  })
  
  .data("owl.carousel").onResize(), $(".owl-carousel.single2").length > 0 && $(".owl-carousel.single2").owlCarousel({
      margin: 30,
      items: 1,
      loop: false,
      stagePadding: 15,
	  autoHeight: true,
      dotsContainer: $(".owl-carousel.single2").parents(".owl-container").find(".slider-dot-container")
  })
